...
| ID | 活動 | 種別 | ページ |
|---|---|---|---|
| `app` | 💻 学びの扉アプリ | 学習サービスの開発・運営（事業） | `/app` |
| `community` | 🎓 学生学修コミュニティ「まなとび」 | 三重大学での探究活動 | `/community` |
| `music` | 🎵 音楽活動「まなとび。」 | 楽曲制作・配信リリース | `/music` |
...
| 対象 | 正しい表記 | 英記 |
|---|---|---|
| 総称（組織全体） | 学びの扉 | Manabi-no-Tobira |
| 学習サービスの事業 | 学びの扉アプリ | Manabi-no-Tobira App |
| 三重大学の探究活動 | 学生学修コミュニティ「まなとび」（**句点なし**） | Manatobi Student Community |
| 音楽活動 | 音楽活動「まなとび。」（**句点あり**） | **Manatobi.** |
...
| 廃止したもの | 現在の扱い |
|---|---|
| 旧組織名 **マナトビ** | 組織の総称は **学びの扉** です |
| 旧製品名 **Chem-Basis** | サイト上では **学習アプリ** と表記します |
| 共通テスト **「情報I」** の教材 | 提供終了。`MATERIAL_ITEMS` から削除済み |
| **一問一答（クイズ）機能** | 機能ごと削除（`/quiz` ルート・`QuizSystem.tsx` を撤去） |
...
| Apple Music | https://music.apple.com/jp/artist/6778055206 |
| Spotify | https://open.spotify.com/artist/1TE2hPWGvYMv1QnekkPISn |
| 1作目 | 「誕生」・2026-06-08 配信開始・全1曲・4:50・J-Pop |
| 1作目クレジット | 作詞・作曲・プロデュース・ボーカル：まなとび。 |
| 2作目 | 「誕生 (Kasanimaro Special Mix)」・2026-06-22 配信開始・全1曲 |
| 2作目クレジット | 作詞・作曲・ボーカル：まなとび。／ミキシングエンジニア：べんとう |
| フォーマット | AAC-LC 320kbps ／ ハイレゾ FLAC 44.1kHz/24bit |
